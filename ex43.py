...
class CentralCorridor(Scene):
	...
	def enter(self):
		...
		if action == "shoot!":
			...
			print "His clown costume os flowing and moving around his body, which throws"
			...
			print "You wake up shortly after only to die as the Gothon stamps on"
			...
			print "Lbhe zbfure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr."
...
class TheBridge(Scene):
	...
	def enter(self):
		...
		print "clown costume than the last. They haven't puled their"
...
class EscapePod(Scene):
	...
	def enter(self):
		...
		if int(guess) != good_pod:
			...
			print "back adn see your ship implode then explode like a"
